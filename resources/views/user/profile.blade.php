...
@section('content')
    <div>
        <div class="container-fluid">
            <div class="row profile_page_infos @if($user->role_id == 1) background-image-role1 @elseif($user->role_id == 3) background-image-role3 @else background-image-role2 @endif">
