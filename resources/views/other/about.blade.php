    ...
    <div class="row mt-5 justify-content-between">
        ...
        <div class="col-12 col-lg-5">
            ...
            <p class="simple_text text-light">
                ...
                <br><br>
                <img src="{{ asset('images/assets/header_badges.png') }}" alt="" class="about_badges mt-5" style="display: block; margin: 0 auto;">
                <br><br>
    ...
    try {
        ...
        <div class="col-12 col-lg-5">
            ...
            <p class="simple_text text-light">
                ...
                <br><br>
                <img src="{{ asset('images/assets/about_messenger.jpg') }}" alt="" class="about_messenger mt-5" style="display: block; margin: 0 auto;">
            </p>
