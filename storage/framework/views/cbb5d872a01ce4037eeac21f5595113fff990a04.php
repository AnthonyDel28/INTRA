...
<head>
    ...
    <script src="<?php echo e(asset('js/lottie.js')); ?>"></script>
    <link rel="icon" href="<?php echo e(asset('intra.ico')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/app_layout.css')); ?>">
...
<?php /**PATH /mnt/c/xampp/htdocs/INTRA/resources/views/layouts/app_layout.blade.php ENDPATH**/ ?>